...
public class Metrica {
    ...
    public void calcularGanador(Ejercito e1, Ejercito e2, viewMain ventana) {
        Random rand = new Random();
        int total1 = e1.puntosTotales();
        int total2 = e2.puntosTotales();
        int total = total1 + total2;
        ...
        ventana.escribirConsola("MÉTRICA DE BATALLA");
        ventana.escribirConsola("Ejército 1: " + e1.getReino() + " -> " + String.format("%.2f", p1) + "% de victoria.");
        ventana.escribirConsola("Ejército 2:" + e2.getReino() + " -> " + String.format("%.2f", p2) + "% de victoria.");
        ventana.escribirConsola("Número aleatorio generado: " + String.format("%.2f", aleatorio));

        if (aleatorio <= p1)
            ventana.escribirConsola("GANADOR \nEjército 1 - " + e1.getReino() + ". \nYa que al generar los porcentajes de probabilidad de victoria basada en los niveles de vida de sus soldados y aplicando un experimento aleatorio salió vencedor.");
        else
            ventana.escribirConsola("GANADOR \nEjército 2 - " + e2.getReino() + ". \nYa que al generar los porcentajes de probabilidad de victoria basada en los niveles de vida de sus soldados y aplicando un experimento aleatorio salió vencedor.");
